...
/** Côlon uniquement (250 g / 500 g / 1 kg). Cheveux et packs désactivés. */
module.exports = [
  ...
  colonSku({ slug: 'confort-colon-1kg', cpu: '1 kg', price: 499, old_price: 599, sort_order: 3 }),
  {
    ...
    brand: BRAND, category: 'hair', price: 199, old_price: 249, stock: 0,
    ...
    image: 'p-hair-biotin.png', featured: 0, active: 0, sort_order: 4,
  },
  {
    slug: 'pack-colon-cheveux',
    name: 'Pack côlon + cheveux', name_ar: 'باقة القولون والشعر',
    brand: BRAND, category: 'packs', price: 349, old_price: 428, stock: 0,
    ...
    image: 'p-pack-cure.png', featured: 0, active: 0, sort_order: 5,
  },
];
